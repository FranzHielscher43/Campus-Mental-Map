...
Verwendung des Projekts GaussianExample-URP im Ordner /projects!

Dieses Projekt basiert auf dem Github-Projekt von aras-p (https://github.com/aras-p/UnityGaussianSplatting)
